...
- **RF-05: Sidebar Thông tin (Route-card UX)**: Hiển thị danh sách tuyến đường kèm theo tên tuyến, thời gian di chuyển dự kiến (`⏱️ duration`) và chiều dài tuyến (`totalDistance`). Cho phép click chọn thẻ để highlight tuyến tương ứng trên bản đồ.
